...
public class ProductController {
	...
	public ModelAndView searchCategory(@PathVariable String category){
		...
		switch(category){
			case "electrodomesticos": cat = "Pequeños electrodomésticos"; break;
			case "televisores": cat = "Televisores"; break;
			case "videoconsolas": cat = "Videoconsolas"; break;
			case "informatica": cat = "informática"; break;
		}
		...
		return new ModelAndView("index").addObject("products", category_products).addObject("order", order);
	}
	...
	public ModelAndView search(@RequestParam String name){
		...
		return new ModelAndView("index").addObject("products", search_products).addObject("order", order);
	}
